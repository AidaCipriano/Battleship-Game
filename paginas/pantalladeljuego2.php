...
<<<<<<< HEAD
  ...
  <main>
    ...
    <script type="module" src="../includes/mainDificil.js"></script>
  </main>
...
<form>
<label class="form-label" for="form14">Usuario</label>
<input type="text" id="usuario"/>

<label class="form-label" for="form14">Contraseña</label>
